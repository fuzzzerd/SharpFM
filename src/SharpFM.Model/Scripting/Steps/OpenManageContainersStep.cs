...
/// </summary>
public sealed class OpenManageContainersStep : ScriptStep, IStepFactory
{
    ...
    public static new ScriptStep FromXml(XElement step) =>
        StepXmlParser.Parse<OpenManageContainersStep>(step, Metadata);

    public static ScriptStep FromDisplayParams(bool enabled, string[] hrParams) =>
        StepDisplayParser.Parse<OpenManageContainersStep>(enabled, hrParams, Metadata);
