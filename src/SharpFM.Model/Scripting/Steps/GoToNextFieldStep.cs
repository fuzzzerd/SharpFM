...
/// </summary>
public sealed class GoToNextFieldStep : ScriptStep, IStepFactory
{
    public const int XmlId = 5;
    public const string XmlName = "Go to Next Field";

    public GoToNextFieldStep(bool enabled = true) : base(null, enabled) { }
    ...
    public static new ScriptStep FromXml(XElement step) =>
        new GoToNextFieldStep(step.Attribute("enable")?.Value != "False");

    public static ScriptStep FromDisplayParams(bool enabled, string[] _) =>
        new GoToNextFieldStep(enabled);
