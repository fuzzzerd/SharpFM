...
/// </summary>
public sealed class OpenHelpStep : ScriptStep, IStepFactory
{
    ...
    public static new ScriptStep FromXml(XElement step) =>
        StepXmlParser.Parse<OpenHelpStep>(step, Metadata);

    public static ScriptStep FromDisplayParams(bool enabled, string[] hrParams) =>
        StepDisplayParser.Parse<OpenHelpStep>(enabled, hrParams, Metadata);
