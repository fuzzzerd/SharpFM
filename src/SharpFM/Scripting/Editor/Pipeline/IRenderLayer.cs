...
/// from the shared <see cref="RenderContext"/>. The pipeline owner
/// dispatches lifecycle events to every layer and consolidates
/// invalidations into at most one <c>InvalidateLayer</c> call per
/// affected <see cref="KnownLayer"/>.
/// </summary>
