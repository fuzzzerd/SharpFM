...
public class StepDisplayRendererTests
{
    ...
    // Name native (main bracket); Value + Repetition augmented (trailing groups);
    // Repetition optional with default "1" so it drops when unset.
    ...
    [Fact]
    public void TrailingBrackets_DefaultRepetitionSuppressed()
    {
    ...
    [Fact]
    public void TrailingBrackets_NonDefaultRepetitionShown()
    {
    ...
    [Fact]
    public void NativeOnly_NoTrailingGroups()
    {
