...
public class ChangePasswordStepTests
{
    ...
    public void RoundTrip_CanonicalXml_IsPreserved()
    {
        ...
        var step = ChangePasswordStep.Parse(source);
    ...
    {
        var step1 = ChangePasswordStep.Parse(XElement.Parse(CanonicalXml));
        ...
        var step2 = StepDisplayFactory.TryCreate(ChangePasswordStep.XmlName, true, tokens)!;
