...
public class ConfigureRAGAccountStepTests
{
    ...
    public void RoundTrip_CanonicalXml_IsPreserved()
    {
        ...
        var step = ConfigureRAGAccountStep.Parse(source);
    ...
    {
        var step1 = ConfigureRAGAccountStep.Parse(XElement.Parse(CanonicalXml));
        ...
        var step2 = StepDisplayFactory.TryCreate(ConfigureRAGAccountStep.XmlName, true, tokens)!;
