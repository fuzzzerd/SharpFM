...
public class SetWebViewerStepTests
{
    ...
    public void RoundTrip_CanonicalXml_IsPreserved()
    {
        ...
        var step = SetWebViewerStep.Parse(source);
    ...
    {
        var step1 = SetWebViewerStep.Parse(XElement.Parse(CanonicalXml));
        ...
        var step2 = StepDisplayFactory.TryCreate(SetWebViewerStep.XmlName, true, tokens)!;
