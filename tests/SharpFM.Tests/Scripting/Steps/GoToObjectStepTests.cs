...
public class GoToObjectStepTests
{
    ...
    public void RoundTrip_CanonicalXml_IsPreserved()
    {
        ...
        var step = GoToObjectStep.Parse(source);
    ...
    {
        var step1 = GoToObjectStep.Parse(XElement.Parse(CanonicalXml));
        ...
        var step2 = StepDisplayFactory.TryCreate(GoToObjectStep.XmlName, true, tokens)!;
