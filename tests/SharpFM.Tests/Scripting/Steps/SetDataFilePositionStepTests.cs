...
{
    private const string CanonicalXml = """<Step enable="True" id="195" name="Set Data File Position"><Calculation><![CDATA[$x]]></Calculation><position><Calculation><![CDATA[$x]]></Calculation></position></Step>""";

    [Fact]
    public void RoundTrip_CanonicalXml_IsPreserved()
    {
        var source = XElement.Parse(CanonicalXml);
        var step = SetDataFilePositionStep.Parse(source);
    ...
    {
        var step1 = SetDataFilePositionStep.Parse(XElement.Parse(CanonicalXml));
        ...
        var step2 = StepDisplayFactory.TryCreate(SetDataFilePositionStep.XmlName, true, tokens)!;
