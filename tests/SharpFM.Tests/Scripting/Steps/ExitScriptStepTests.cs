...
{
    private const string CanonicalXml = """<Step enable="True" id="103" name="Exit Script"><Calculation><![CDATA[$x]]></Calculation></Step>""";

    [Fact]
    public void RoundTrip_CanonicalXml_IsPreserved()
    {
        var source = XElement.Parse(CanonicalXml);
        var step = ExitScriptStep.Parse(source);
    ...
    {
        var step1 = ExitScriptStep.Parse(XElement.Parse(CanonicalXml));
        ...
        var step2 = StepDisplayFactory.TryCreate(ExitScriptStep.XmlName, true, tokens)!;
