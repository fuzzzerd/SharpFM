...
{
    private const string CanonicalXml = """<Step enable="True" id="147" name="Set Field By Name"><TargetName><Calculation><![CDATA[$x]]></Calculation></TargetName><Result><Calculation><![CDATA[$x]]></Calculation></Result></Step>""";

    [Fact]
    public void RoundTrip_CanonicalXml_IsPreserved()
    {
        var source = XElement.Parse(CanonicalXml);
        var step = SetFieldByNameStep.Parse(source);
    ...
    {
        var step1 = SetFieldByNameStep.Parse(XElement.Parse(CanonicalXml));
        ...
        var step2 = StepDisplayFactory.TryCreate(SetFieldByNameStep.XmlName, true, tokens)!;
