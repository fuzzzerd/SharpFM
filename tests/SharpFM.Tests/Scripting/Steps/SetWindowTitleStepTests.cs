...
public class SetWindowTitleStepTests
{
    ...
    public void RoundTrip_CanonicalXml_IsPreserved()
    {
        ...
        var step = SetWindowTitleStep.Parse(source);
    ...
    {
        var step1 = SetWindowTitleStep.Parse(XElement.Parse(CanonicalXml));
        ...
        var step2 = StepDisplayFactory.TryCreate(SetWindowTitleStep.XmlName, true, tokens)!;
