...
public class ConfigureAIAccountStepTests
{
    ...
    public void RoundTrip_CanonicalXml_IsPreserved()
    {
        ...
        var step = ConfigureAIAccountStep.Parse(source);
    ...
    {
        var step1 = ConfigureAIAccountStep.Parse(XElement.Parse(CanonicalXml));
        ...
        var step2 = StepDisplayFactory.TryCreate(ConfigureAIAccountStep.XmlName, true, tokens)!;
