...
public class ResetAccountPasswordStepTests
{
    ...
    public void RoundTrip_CanonicalXml_IsPreserved()
    {
        ...
        var step = ResetAccountPasswordStep.Parse(source);
    ...
    {
        var step1 = ResetAccountPasswordStep.Parse(XElement.Parse(CanonicalXml));
        ...
        var step2 = StepDisplayFactory.TryCreate(ResetAccountPasswordStep.XmlName, true, tokens)!;
