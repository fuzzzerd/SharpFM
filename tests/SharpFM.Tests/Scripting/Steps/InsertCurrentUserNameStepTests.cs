...
{
    private const string CanonicalXml = """<Step enable="True" id="60" name="Insert Current User Name"><SelectAll state="False"/><Field table="Invoices" id="12" name="Status"/></Step>""";
