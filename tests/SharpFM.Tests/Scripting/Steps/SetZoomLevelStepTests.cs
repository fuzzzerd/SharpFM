...
public class SetZoomLevelStepTests
{
    ...
    public void RoundTrip_CanonicalXml_IsPreserved()
    {
        ...
        var step = SetZoomLevelStep.Parse(source);
    ...
    {
        var step1 = SetZoomLevelStep.Parse(XElement.Parse(CanonicalXml));
        ...
        var step2 = StepDisplayFactory.TryCreate(SetZoomLevelStep.XmlName, true, tokens)!;
