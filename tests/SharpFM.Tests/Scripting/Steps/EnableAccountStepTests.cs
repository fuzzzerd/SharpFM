...
public class EnableAccountStepTests
{
    ...
    public void RoundTrip_CanonicalXml_IsPreserved()
    {
        ...
        var step = EnableAccountStep.Parse(source);
    ...
    {
        var step1 = EnableAccountStep.Parse(XElement.Parse(CanonicalXml));
        ...
        var step2 = StepDisplayFactory.TryCreate(EnableAccountStep.XmlName, true, tokens)!;
