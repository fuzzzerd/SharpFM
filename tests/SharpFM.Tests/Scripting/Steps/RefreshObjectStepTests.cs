...
{
    private const string CanonicalXml = """<Step enable="True" id="167" name="Refresh Object"><ObjectName><Calculation><![CDATA[$x]]></Calculation></ObjectName><Repetition><Calculation><![CDATA[$x]]></Calculation></Repetition></Step>""";

    [Fact]
    public void RoundTrip_CanonicalXml_IsPreserved()
    {
        var source = XElement.Parse(CanonicalXml);
        var step = RefreshObjectStep.Parse(source);
    ...
    {
        var step1 = RefreshObjectStep.Parse(XElement.Parse(CanonicalXml));
        ...
        var step2 = StepDisplayFactory.TryCreate(RefreshObjectStep.XmlName, true, tokens)!;
