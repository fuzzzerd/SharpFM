...
public class SetDictionaryStepTests
{
    ...
    public void RoundTrip_CanonicalXml_IsPreserved()
    {
        ...
        var step = SetDictionaryStep.Parse(source);
    ...
    {
        var step1 = SetDictionaryStep.Parse(XElement.Parse(CanonicalXml));
        ...
        var step2 = StepDisplayFactory.TryCreate(SetDictionaryStep.XmlName, true, tokens)!;
