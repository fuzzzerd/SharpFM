...
public class MoveResizeWindowStepTests
{
    ...
    public void RoundTrip_CanonicalXml_IsPreserved()
    {
        ...
        var step = MoveResizeWindowStep.Parse(source);
    ...
    {
        var step1 = MoveResizeWindowStep.Parse(XElement.Parse(CanonicalXml));
        ...
        var step2 = StepDisplayFactory.TryCreate(MoveResizeWindowStep.XmlName, true, tokens)!;
